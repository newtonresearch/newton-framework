...
void
StreamLong(FILE * inFile, int32_t inVal)
{
...
#endif
		fputc(0xFF, inFile);
		fwrite(&inVal, sizeof(int32_t), 1, inFile);
	}
}
...
void
StreamImmediate(FILE * inFile, int32_t inVal)
{
