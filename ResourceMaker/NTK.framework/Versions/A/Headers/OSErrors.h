...
#define kNameAlreadyRegistered	kOSErrAlreadyRegistered
#define kNoSuchNameRegistered		kOSErrNotRegistered
...
#define OSERRIF(expr) do { NewtonErr _err; if ((_err = expr) != noErr) ThrowOSErr(_err); } while (0)
