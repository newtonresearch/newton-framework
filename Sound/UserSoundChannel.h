...
#if !defined(__USERSOUNDCHANNEL_H)
#define __USERSOUNDCHANNEL_H 1
...
protected:
	ULong						fState;				// +14
	ULong						fChannelId;			// +18	id of channel that plays uncompressed 8-bit samples
	ULong						fCodecChannelId;	// +1C	id of channel that plays thru a codec
	ULong						fUniqueId;			// +20
