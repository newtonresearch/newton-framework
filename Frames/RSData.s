...
_RSioProtoShowByButton:	Ref	_RioProtoShowByButton
		.globl	_RSconstantFunctions
_RconstantFunctions:		Ref	MAKEPTR(constantFunctions)
_RSconstantFunctions:	Ref	_RconstantFunctions
		.globl	_RSformInstallScript
_RformInstallScript:		Ref	MAKEPTR(formInstallScript)
_RSformInstallScript:	Ref	_RformInstallScript
		.globl	_RSformRemoveScript
_RformRemoveScript:		Ref	MAKEPTR(formRemoveScript)
_RSformRemoveScript:	Ref	_RformRemoveScript
		.globl	_RSautoInstallScript
_RautoInstallScript:		Ref	MAKEPTR(autoInstallScript)
_RSautoInstallScript:	Ref	_RautoInstallScript
		.globl	_RSspace
